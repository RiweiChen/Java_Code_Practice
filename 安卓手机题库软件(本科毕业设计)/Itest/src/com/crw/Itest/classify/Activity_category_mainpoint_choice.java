...
public class Activity_category_mainpoint_choice extends Activity 
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		c = db.rawQuery("select  distinct qmainpoint   from q_choice where 1",null);
		//获取数据。
		...
		{  
			...
			{  
				...
				String sql="select * from q_choice where qmainpoint="+"'"+data.get(arg2)+"'";
				Intent intent=new Intent(Activity_category_mainpoint_choice.this,Activity_exercise_choice_show.class);
