...
public class Activity_qcategory_fillblank extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		c = db.rawQuery("select  distinct qsource   from q_fillblank where 1",null);
		//获取数据。
		...
		{  
			...
			{  
				...
				String sql="select * from q_fillblank where qsource="+"'"+data.get(arg2)+"'";
				Intent intent=new Intent(Activity_qcategory_fillblank.this,Activity_exercise_fillblank_show.class);
