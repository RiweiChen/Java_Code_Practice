...
public class Activity_category_mainpoint_ask extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		c = db.rawQuery("select distinct qmainpoint from q_ask where 1",null);
		//获取数据。
		...
		{  
			...
			{  
				...
				String sql="select * from q_ask where qmainpoint="+"'"+data.get(arg2)+"'";
				Intent intent=new Intent(Activity_category_mainpoint_ask.this,Activity_exercise_ask_show.class);
