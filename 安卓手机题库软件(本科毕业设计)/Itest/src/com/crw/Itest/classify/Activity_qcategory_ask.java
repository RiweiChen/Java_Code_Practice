...
public class Activity_qcategory_ask extends Activity 
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		c = db.rawQuery("select distinct qsource from q_ask where 1",null);
		//获取数据。
		...
		{  
			...
			{  
				...
				String sql="select * from q_ask where qsource="+"'"+data.get(arg2)+"'";
				Intent intent=new Intent(Activity_qcategory_ask.this,Activity_exercise_ask_show.class);
