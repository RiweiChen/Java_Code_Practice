...
public class Activity_questionshow extends Activity
{
	//各个控件事件。
	...
	Button.OnClickListener clickListener=new Button.OnClickListener()
	{
		...
		public void onClick(View v) 
		{
			...
			case R.id.addcollect:
			{
				...
				//
				AlertDialog.Builder builder =new AlertDialog.Builder(Activity_questionshow.this);    
				builder.setTitle("添加笔记")  ;
				builder.setMessage("请输入笔记内容!"); 
				final EditText edtEditText=new EditText(Activity_questionshow.this);
				...
				builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						Toast.makeText(Activity_questionshow.this,"添加收藏成功！",Toast.LENGTH_SHORT).show();
					}
				});  
			...
			{	
				...
				builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						Toast.makeText(Activity_questionshow.this,"添加错题成功！",
