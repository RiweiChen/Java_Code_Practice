...
public class Activity_question_fillblank_show extends Activity
{
	//各个控件事件。
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.layout_qfillblank);
		getView();//控件id绑定。
    	...
    	//查询数据库。
    	c = db.rawQuery("select * from q_fillblank ",null);
    	c.moveToFirst();
    	getResult(c);
    	setView();
	...
	Button.OnClickListener clickListener=new Button.OnClickListener()
	{
		...
		public void onClick(View v) 
		{
			...
			case R.id.addcollect:
			{
				...
				//
				AlertDialog.Builder builder =new AlertDialog.Builder(Activity_question_fillblank_show.this);    
				builder.setTitle("添加笔记")  ;
				builder.setMessage("请输入笔记内容!"); 
				final EditText edtEditText=new EditText(Activity_question_fillblank_show.this);
				...
				builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						Toast.makeText(Activity_question_fillblank_show.this,"添加收藏成功！",Toast.LENGTH_SHORT).show();
					}
				});  
			...
			{	
				...
				builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						Toast.makeText(Activity_question_fillblank_show.this,"添加错题成功！",
