...
public class Activity_collect_fillblank_show extends ListActivity
{
    ...
    public boolean onContextItemSelected(MenuItem item)
    {
        ...
        case 0://删除
        	db.execSQL("delete from f_fillblank where uid="+uid+" and qid="+qid);
        	Toast.makeText(Activity_collect_fillblank_show.this, "成功删除！", Toast.LENGTH_SHORT);
        	setAdapter();
            break;
        case 1://查看。
        	show(qid);
        	Toast.makeText(Activity_collect_fillblank_show.this, "查看！", Toast.LENGTH_SHORT);
            break;    
        case 2://更改。
        	alter(qid);
        	Toast.makeText(Activity_collect_fillblank_show.this, "修改成功！", Toast.LENGTH_SHORT);
        	setAdapter();
            break;
        }
        return true;
	...
	{ 
    	c = db.rawQuery("select q_fillblank.qid,qtitle,qanswer,comment from q_fillblank ,e_fillblank where q_fillblank.qid=e_fillblank.qid and uid="+uid,null);
		//清空内容。
    	list.clear();
		idList.clear();
		while(c.moveToNext())
	...
	public void alter(int id ) 
	{
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(
				Activity_collect_fillblank_show.this);
		builder.setTitle("更改");
		...
		builder.setPositiveButton("确定",
				new DialogInterface.OnClickListener() 
				{
					...
					public void onClick(DialogInterface dialog,
						...
						db.execSQL("update f_fillblank set importance='"+newnote+"' where uid="+uid+" and qid="+qid);
						return;
					}
				});
	...
	public void  show(int qid) 
	{
		   ...
		   c=db.rawQuery("select * from q_fillblank where qid="+qid, null);
		   c.moveToFirst();
		   ...
		   new AlertDialog.Builder(Activity_collect_fillblank_show.this)
