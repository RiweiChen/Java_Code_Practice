...
public class Activity_error_fillblank_show extends ListActivity
{
    ...
    public boolean onContextItemSelected(MenuItem item)
    {
        ...
        case 0://删除
        	db.execSQL("delete from e_fillblank where uid="+uid+" and qid="+qid);
        	Toast.makeText(Activity_error_fillblank_show.this, "成功删除！", Toast.LENGTH_SHORT);
        	setAdapter();
            break;
        case 1://查看。
        	show(qid);
        	Toast.makeText(Activity_error_fillblank_show.this, "查看！", Toast.LENGTH_SHORT);
            break;    
        case 2://更改。
        	alter(qid);
        	Toast.makeText(Activity_error_fillblank_show.this, "修改成功！", Toast.LENGTH_SHORT);
        	setAdapter();
            break;
        }
        return true;
	...
	public void alter(int id ) 
	{
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(
				Activity_error_fillblank_show.this);
		builder.setTitle("更改");
		...
		builder.setPositiveButton("确定",
				new DialogInterface.OnClickListener() 
				{
					...
					public void onClick(DialogInterface dialog,
						...
						db.execSQL("update e_fillblank set comment='"+newnote+"' where uid="+uid+" and qid="+qid);
						return;
					}
				});
	...
	public void  show(int qid) 
	{
		   ...
		   new AlertDialog.Builder(Activity_error_fillblank_show.this)
