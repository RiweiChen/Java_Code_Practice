...
public class Activity_error_choice_show extends ListActivity
{
	...
	{
		adapter = new SimpleAdapter(this,getData(),R.layout.error_choice, 
		new String[]{"qid","qtitle","qoptA","qoptB","qoptC","qoptD","qanswer","qimportance","qyouanswer"}, 
		new int[]{R.id.qid,R.id.qtitle,R.id.qoptA,R.id.qoptB,R.id.qoptC,R.id.qoptD,R.id.qanswer,R.id.qimportance,R.id.qyouanswer}); 
	...
	//创建上下文菜单
	    ...
	    public boolean onContextItemSelected(MenuItem item)
	    {
	        ...
	        case 0://删除
	        	db.execSQL("delete from e_choice where uid="+uid+" and qid="+qid);
	        	Toast.makeText(Activity_error_choice_show.this, "成功删除！", Toast.LENGTH_SHORT);
	        	setAdapter();
	            break;
	        case 1://查看。
	        	show(qid);
	        	Toast.makeText(Activity_error_choice_show.this, "查看！", Toast.LENGTH_SHORT);
	            break;    
	        case 2://更改。
	        	alter(qid);
	        	Toast.makeText(Activity_error_choice_show.this, "修改成功！", Toast.LENGTH_SHORT);
	        	setAdapter();
	            break;
	        }
	        return true;
	...
	{ 
    	c = db.rawQuery("select q_choice.qid,qtitle,qoptA,qoptB,qoptC,qoptD,qanswer,comment ,youanswer from q_choice ,e_choice where q_choice.qid=e_choice.qid and uid="+uid,null);
    	list.clear();
		idList.clear();
		while(c.moveToNext())
		{
			...
			String youanswer=c.getString(c.getColumnIndex("youanswer"));
			...
			map.put("qyouanswer","你的答案:"+youanswer); 
			list.add(map);
	...
	public void alter(int id ) 
	{
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(
				Activity_error_choice_show.this);
		builder.setTitle("更改");
		...
		builder.setPositiveButton("确定",
				new DialogInterface.OnClickListener() 
				{
					...
					public void onClick(DialogInterface dialog,
						...
						db.execSQL("update e_choice set comment='"+newnote+"' where uid="+uid+" and qid="+qid);
						return;
					}
				});
	...
	public void  show(int qid) 
	{
		   ...
		   new AlertDialog.Builder(Activity_error_choice_show.this)
