...
public class Activity_collect_ask_show extends ListActivity
{
    ...
    public boolean onContextItemSelected(MenuItem item)
    {
        ...
        case 0://删除
        	db.execSQL("delete from f_ask where uid="+uid+" and qid="+qid);
        	Toast.makeText(Activity_collect_ask_show.this, "成功删除！", Toast.LENGTH_SHORT).show();
        	setAdapter();
            break;
        case 1://查看。
        	show(qid);
        	Toast.makeText(Activity_collect_ask_show.this, "查看！", Toast.LENGTH_SHORT).show();
            break;    
        case 2://更改。
        	alter(qid);
        	Toast.makeText(Activity_collect_ask_show.this, "修改成功！", Toast.LENGTH_SHORT).show();
        	setAdapter();
            break;
        }
        return true;
	...
	{ 
		...
		c = db.rawQuery("select q_ask.qid,qtitle,qanswer,importance from q_ask ,f_ask where q_ask.qid=f_ask.qid and uid="+uid,null);
		list.clear();
		idList.clear();
		while(c.moveToNext())
		{
	...
	public void alter(int id ) 
	{
		...
		AlertDialog.Builder builder = new AlertDialog.Builder(
				Activity_collect_ask_show.this);
		builder.setTitle("更改");
		...
		builder.setPositiveButton("确定",
				new DialogInterface.OnClickListener() 
				{
					...
					public void onClick(DialogInterface dialog,
						...
						db.execSQL("update f_ask set importance='"+newnote+"' where uid="+uid+" and qid="+qid);
						return;
					}
				});
	...
	public void  show(int qid) 
	{
		   ...
		   new AlertDialog.Builder(Activity_collect_ask_show.this)
