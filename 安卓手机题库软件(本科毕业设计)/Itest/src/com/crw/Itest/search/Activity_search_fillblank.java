...
public class Activity_search_fillblank extends ListActivity
{
	@Override
	...
	{ 
		...
		//设置适配器。
		SimpleAdapter adapter = new SimpleAdapter(this,getData(),R.layout.search_fillblank, 
	...
	{ 
    	...
    	c = db.rawQuery("select * from q_fillblank" +
